...
public class linkedpositionallist<E> implements positionallist<E> {
    ...
    @Override                 //return position after given position 
    ...
    @Override    //return position before given position 
    public position<E> before(position<E> p) throws IllegalAccessException  
    {
     ...
     @Override     //add element at front of list 
     public position<E> addfirst(E e) throws IllegalAccessException            
    {   
        return addbetween(e,header,header.getnext() );
    }
    @Override    //add element at end of list
    ...
    @Override  //add element before P and return its new position 
    ...
    @Override    //remove  position from list and return removed element 
